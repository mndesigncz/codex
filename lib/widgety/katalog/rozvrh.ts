// Widgety oblasti „Rozvrh" — metadata bez Reactu (kolo 68).
//
// Komponenty jsou v components/widgety/oblasti/rozvrh.tsx. Widget se stavem 'planovany' komponentu
...
export const WIDGETY: DefiniceWidgetu[] = [
  ...
  // Data: GET /api/timeoff → requests[{employeeName,fromDate,toDate,type,status}]
  {
    ...
    popis: 'Čekající žádosti o volno (kdo, od–do, typ) se Schválit/Zamítnout; schválené volno v měsíci.',
    ikona: 'calendar',
    velikosti: ['S', 'M'],
    vychoziVelikost: 'M',
    rozhrani: ['vedeni'],
