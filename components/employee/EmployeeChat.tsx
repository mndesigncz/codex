...
const QUICK_PHRASES = ['🤒 Dnes jsem nemocný/á', '⏰ Přijdu později', '✅ Směna v pořádku', '🙏 Potřebuji výměnu směny'];
...
export default function EmployeeChat({ user }: Props) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Quick phrases */}
      <div className="flex-shrink-0 px-4 pt-3 flex gap-2 overflow-x-auto scrollbar-thin">
      ...
      <form onSubmit={sendMessage} className="flex-shrink-0 p-4 border-t border-black/[0.06] backdrop-blur-xl glass flex gap-3 mt-3">
        <input
          value={newMessage}
