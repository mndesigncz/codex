...
// Widgety oblasti „Menu" — komponenty (kolo 68, spec §2.5).
//
// Vlastník v kole 69: balík B4 (spec §6.3) — do souboru nesahá nikdo jiný.
// Metadata (název, velikosti, oprávnění, `stav`) jsou v lib/widgety/katalog/menu.ts;
